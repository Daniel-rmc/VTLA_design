...
The Stage 2 launcher defaults to physical GPUs selected by free memory, batch size 32/GPU, both available cameras, both tactile sensors, and 500 epochs. To force the last three GPUs explicitly:
